...
// // ADMIN ONLY - Get ALL flights (active + inactive)
...
// // PUBLIC - Get active flights (with optional destination filter)
...
//     // Important: filter by destination if provided
//     if (destination) {
//       filter.destination = destination;
//     }

//     const flights = await Flight.find(filter)
//       .populate('destination', 'name country')   // optional but helpful
...
// // PUBLIC - Get single flight by ID
