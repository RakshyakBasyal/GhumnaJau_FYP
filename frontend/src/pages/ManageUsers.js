...
//       try {
//         const res = await getUsers(); // Your backend /api/users (admin protected)
//         const data = res.data || []; // Default to empty array if data is undefined
//         setUsers(data);
...
//         (user.fullName?.toLowerCase() || '').includes(lowerQuery) || // Safe check
//         (user.email?.toLowerCase() || '').includes(lowerQuery)      // Safe check
//       );
...
//     // TODO: Call backend to update user status (active/disabled)
