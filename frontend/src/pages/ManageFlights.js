...
//   const [destinations, setDestinations] = useState([]); // ← new state for dropdown
...
//     price: '',
//     class: 'Economy',
//     destination: '', // will store the _id
//     departureDate: '',
//     availableSeats: 100,
//     isActive: true,
//   });
...
//   // Fetch both flights and destinations
//   useEffect(() => {
//     fetchFlights();
//     fetchDestinations();
//   }, []);
...
//       showToast('Failed to load destinations for dropdown', 'error');
//     }
//   };
...
//       destination: flight.destination?._id || flight.destination || '', // important!
...
//                       No destinations found. Please add some in Manage Destinations first.
//                     </p>
//                   )}
//                 </div>
