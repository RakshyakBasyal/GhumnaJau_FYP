...
// //   // ✅ costMode controls whether admin enters a single cost OR a range
// //   const [costMode, setCostMode] = useState("range"); // "range" | "single"
...
// //     // rating is float, costs are numbers but store as string (input value), convert before sending if you want
// //     setFormData((prev) => ({
// //       ...prev,
...
// //     // If single mode: clear min/max
// //     // If range mode: clear averageCost
// //     if (costMode === "single") {
// //       return {
...
// //     // only append if values exist, so backend doesn't overwrite with empty strings
// //     if (costs.averageCost !== "" && costs.averageCost != null) {
// //       data.append("averageCost", String(costs.averageCost));
// //     }
// //     if (costs.averageCostMin !== "" && costs.averageCostMin != null) {
// //       data.append("averageCostMin", String(costs.averageCostMin));
// //     }
// //     if (costs.averageCostMax !== "" && costs.averageCostMax != null) {
// //       data.append("averageCostMax", String(costs.averageCostMax));
// //     }
...
// //     if (dest.averageCost !== undefined && dest.averageCost !== null && dest.averageCost !== "") {
// //       return `$${dest.averageCost}`;
// //     }
// //     if (
// //       (dest.averageCostMin !== undefined && dest.averageCostMin !== null && dest.averageCostMin !== "") ||
// //       (dest.averageCostMax !== undefined && dest.averageCostMax !== null && dest.averageCostMax !== "")
// //     ) {
// //       const min = dest.averageCostMin ?? "";
// //       const max = dest.averageCostMax ?? "";
...
// //               <div>
// //                 <label className="block text-sm font-medium text-gray-700 mb-2">
// //                   Short Description (shows on Landing cards)
// //                 </label>
// //                 <input
// //                   type="text"
...
// //                       Tip: Use this if you want ONE fixed average cost.
// //                     </p>
// //                   </div>
// //                 ) : (
...
// //                       Tip: Use range if costs vary (like “$800 - $1500”).
// //                     </p>
// //                   </div>
// //                 )}
// //               </div>
...
// // ✅ prevent floating issues like 2000 -> 1998/1999
// const toInt = (v) => {
//   const n = Number(v);
...
//     // ✅ cost fields (kept as strings in inputs)
//     averageCost: "",
//     averageCostMin: "",
//     averageCostMax: "",
//   });
...
//     // ✅ keep costs as string while typing
//     // ✅ rating as number (fine)
//     setFormData((prev) => ({
//       ...prev,
...
//     // ✅ cost fields (send INTs only, rounded)
//     const costs = normalizeCostFields();
...
// ✅ touchpad/scroll wheel fix: stop number inputs from changing on wheel
const preventWheelChange = (e) => {
  // blur stops the value-changing behavior
  e.target.blur();
  // refocus so UX is still smooth
                ...
                {costMode === "single" ? (
                  <div className="mt-4">
                    ...
                    <input
                      ...
                      value={formData.averageCost}
                      onChange={handleChange}
                      onWheel={preventWheelChange}   // ✅ FIX
                      className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none"
                      placeholder="e.g., 1200"
                    />
                  </div>
